...
const ShapeGrid = ({
  ...
  squareSize = 50,
  hoverFillColor = 'rgba(0, 255, 153, 0.15)',
  shape = 'square',
  hoverTrailAmount = 3
}) => {
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Add radial gradient overlay centered in screen
      ...
      gradient.addColorStop(0, 'rgba(28, 28, 34, 0)');
      gradient.addColorStop(1, '#1c1c22'); // blends perfectly with body background
